        ...
        <div className="">
            {fetched && <>
                {questionNumber <= data.length - 1 ? (
                    <div key={data[questionNumber].id} className="border border-blue-secondary h-min-80 rounded-lg mx-20 mobiles:mx-4 mobiles:px-6 my-4 px-12 py-12">
                        <h1 className="text-xl mb-2">{data[questionNumber].Questions}</h1>
                        {!answered && (
                            <div className="mt-4 mobiles:flex-col mobiles:flex">
                        ...
                        {answered && (
                            <>
                                ...
                                <div className="w-full flex justify-end">
                                    <button
                                        className="flex text-purple-primary font-bold cursor-pointer px-2 mobiles:mt-4"
